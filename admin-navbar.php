		<form action="engine.php" method="post">
			...
			<button class="btn btn-inverse" type="submit" name="formname" value="managejobs">Manage Jobs</button>
			<button class="btn btn-inverse" type="submit" name="formname" value="manageservers">Manage Servers</button>
			<button class="btn btn-inverse" type="submit" name="formname" value="managekeys">Manage Keys</button>
			<button class="btn btn-inverse" type="submit" name="formname" value="manageburns">Manage Burns</button>
